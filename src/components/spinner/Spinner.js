const Spinner = () => {
    return (
      <svg width="200px" height="200px" display="block" shapeRendering="auto" style={{margin: '0 auto', background: 'none', display: 'block'}} preserveAspectRatio="xMidYMid" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      <g transform="rotate(0 50 50)">
      <rect x="47" y="24" width="6" height="12" rx="3" ry="6" fill="#e37239">
